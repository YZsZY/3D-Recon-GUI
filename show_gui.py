...
class NGPGUI:
    ...
    def register_dpg(self):
        dpg.create_context()
        dpg.create_viewport(title="四牌楼重建", width=self.W, height=self.H, resizable=True) # 创建窗口
        ...
        dpg.set_primary_window("_primary_window", True) # 设置为主窗口
...
if __name__ == "__main__":
    ...
    NGPGUI(hparams, dataset.K, dataset.img_wh).render() # 先初始化，完成之后一直调用render
    dpg.destroy_context()
