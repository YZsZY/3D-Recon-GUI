...
class NeRFSystem(LightningModule):
    def __init__(self, hparams):
        ...
        self.loss = NeRFLoss(lambda_distortion=self.hparams.distortion_loss_w)  # 简单的RGB_loss
    ...
    def validation_step(self, batch, batch_nb):
        ...
        if not self.hparams.no_save_test:  # save test image to disk
            print("Now is in the test stage")
            idx = batch['img_idxs']
            ...
            print("The image in the val stage has been saved..")
...
if __name__ == '__main__':
    ...
    print("The best model is saved in the path: ", ckpt_cb.best_model_path)
    ...
    if not hparams.val_only:  # save slimmed ckpt for the last epoch
        ...
        torch.save(ckpt_,
                   f'ckpts/{hparams.dataset_name}/{hparams.exp_name}/epoch={hparams.num_epochs - 1}_scale={int(100 * hparams.scale)}_downsample={int(100 * hparams.downsample)}_slim.ckpt')
    ...
    if (not hparams.no_save_test) and hparams.dataset_name == 'nsvf' and 'Synthetic' in hparams.root_dir:  # save video
        ...
        imageio.mimsave(os.path.join(system.val_dir, 'depth.mp4'),
                        ...
                        fps=30, macro_block_size=1)
# python train.py --root_dir data/yangang_Recon/flowerbed
